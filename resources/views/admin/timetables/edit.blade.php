...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-gray-100">
            <nav class="p-3 bg-white flex justify-between">
                <ul class="flex items-center">
                    <h1 class="text-3xl font-semibold text-gray-800 mb-6">Edit Timetable</h1>
                </ul>
                <ul class="flex items-center">
                    <a href="
        ...
        <!-- Form starts here -->
        <form action="{{ route('admin.timetable.update',$timetable->id) }}" method="POST" class="space-y-6 bg-white p-8 rounded-lg shadow-md">
                     @method('patch')
                     @csrf
            <!-- Subject Field -->
            <div>
